...
load("test1specialobjects.RData")
...
#  you can run the following line to create the correct cpi object
# In case you are unable to do the join, you can use the joined_data 
# object created by the below code for the linear regression part
