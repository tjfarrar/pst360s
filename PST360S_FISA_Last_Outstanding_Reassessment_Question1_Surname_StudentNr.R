# PST360S FISA Question 1 Answer Script
# Name: 
# Student Number: 
...
# ONLY YOUR CODE WRITTEN IN THIS FILE AND UPLOADED ON BLACKBOARD, 
#  OR COPIED INTO THE ANSWER BOX IN BLACKBOARD, WILL BE MARKED.
...
load("reassessment_objects.RData")
...
# 1 d)
# Note: In case you were unable to do 1 c) correctly, 
#  you can run the following line to create the correct summary2 object
#  (this will not earn you any marks for 1 c))
load("reassessment_objects.RData")
...
# 1 f)
# Note: In case you were unable to do 1 e) correctly, 
#  you can run the following line to create the correct dat3 object
#  (this will not earn you any marks for 1 e))
load("reassessment_objects_2.RData")
