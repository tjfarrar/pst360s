# PST360S Test 1 (Special Assessment) Answer Script
# Name: 
# Student Number: 
...
# ONLY CODE THAT IS COPIED-AND-PASTED TO BLACKBOARD WILL BE MARKED.
...
#  you can run the following line to create the correct cities object
